...
type
  ...
  public
    ...
    procedure UpdateMesh(const NewFacesList: TFacesList; const MaxVerticeCount: integer; const NoEdges, NoAutoScale: boolean); overload; virtual;
...
procedure TBaseOpenGLHelper.UpdateMesh(const NewFacesList: TFacesList; const MaxVerticeCount: integer; const NoEdges, NoAutoScale: boolean);
begin
  // EMPTY
end;
