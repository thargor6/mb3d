...
type
  ...
  public
    ...
    property SurfaceSharpness: Double read FSurfaceSharpness write FSurfaceSharpness;
...
begin
  if ThreadCount < 1 then
    raise Exception.Create('Invalid ThreadCount <'+IntToStr(ThreadCount)+'>');
...
{ ---------------------------- TVertexGen2Config ----------------------------- }
constructor TVertexGen2Config.Create;
begin
  inherited Create;
...
procedure TVertexGen2Config.Clear;
begin
  FTraceRanges.Clear;
end;

procedure TVertexGen2Config.AddSampledTraceRanges( VertexList: TPS3VectorList; NormalsList, ColorList: TPSMI3VectorList );
var
  I: Integer;
  Range: TTraceRange;
begin
