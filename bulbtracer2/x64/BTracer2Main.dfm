object BTracer2Frm: TBTracer2Frm
  Left = 0
  Top = 0
  Caption = 'BTracer2 (Win64)'
  ClientHeight = 301
  ClientWidth = 793
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object LoadTraceDataBtn: TButton
      Left = 12
      Top = 13
      Width = 575
      Height = 25
      Caption = 'Load BTracer2 Trace-Data...'
      TabOrder = 1
      OnClick = LoadTraceDataBtnClick
    end
  ...
  object FileOpenDialog: TFileOpenDialog
    DefaultExtension = 'btracer2'
    FavoriteLinks = <>
    FileTypes = <
      item
        DisplayName = 'BTracer2 Trace-Data (*.btracer2)'
        FileMask = '*.btracer2'
      end>
