...
procedure SaveZBuf(FileName: String; stype: Integer;  const ZOffset, ZScale: double; const InvertZBuffer:boolean);
var tbmp: TBitmap;
    TileRect: TRect;
    Crop: Integer;
begin
  if stype = 3 then
    SaveZBufPNG16(Filename, ZOffset, ZScale, InvertZBuffer)
  else begin
    tbmp := TBitmap.Create;
    try
